    ...
    <section className="bg-[#F4F2EE] py-24">
      <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
        <div className="bg-[#0A1628] rounded-3xl px-8 py-16 lg:py-20 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-72 h-72 bg-[#F5C518] opacity-[0.05] rounded-full blur-[80px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-56 h-56 bg-white opacity-[0.03] rounded-full blur-[60px] pointer-events-none" />
          <div className="relative">
            <div className="w-10 h-1 bg-[#F5C518] mx-auto mb-8 rounded-full" />
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
              <Link
                href="/contact"
                className={`inline-flex items-center justify-center bg-[#F5C518] hover:bg-[#FAE060] text-[#0A1628] font-bold text-sm px-8 py-4 rounded-full transition-colors duration-300 shadow-lg shadow-[#F5C518]/20 ${isRTL ? 'font-persian' : ''}`}
              >
                {t('ctaBook')}
              </Link>
              <a
